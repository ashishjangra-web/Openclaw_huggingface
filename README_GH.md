...
> [!NOTE]
> This file is named `README_GH.md` to avoid conflicts with the standard `README.md` required by Hugging Face (which contains Space metadata and configurations).
...
| `GATEWAY_TOKEN` | (Optional) Your password for the Web UI |
